...
switch ($page) {
    ...
    case 0:
        ...
        $smarty->assign("page_title", "Mock pagoPA - Attiva PSP");
        $smarty->display('views/attiva_0.tpl');
    ...
    case 1:
        ...
        $RTrequest = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ws="http://ws.pagamenti.telematici.gov/">
               ...
               <soapenv:Body>
                  <ws:nodoAttivaRPT>
                     ...
                     <codiceContestoPagamento>'.$_POST['password'].'</codiceContestoPagamento>
                     <identificativoIntermediarioPSPPagamento>'.$_POST['password'].'</identificativoIntermediarioPSPPagamento>
                     <identificativoCanalePagamento>'.$_POST['password'].'</identificativoCanalePagamento>
        ...
        $status=$responseBodyXML->soapenvBody->nodoAttivaRPTRisposta->esito;


        $smarty->assign("message", $status);
        $smarty->display('views/attiva_1.tpl');

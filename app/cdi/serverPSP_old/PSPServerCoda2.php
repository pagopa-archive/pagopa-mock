<?php
    ...
    //Log
    $time = date('d-M-Y');
    $logPath='../uploads/logs/log-PSPCoda2-' . $time . '.txt';
    ...
    foreach ($rts as $rt) {
        ...
        $RTsettings = json_decode($rt["rtarray"], true);
        ...
        try {
            ...
            $log->error("Esecuzione RT in coda per pspInviaCarrelloRPTCarte: " . $e->getMessage());
        }

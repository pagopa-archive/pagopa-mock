<?php
    ...
    class PAServerPagamentoPSP
    {
        ...
        function paaAttivaRPT()
        {
            ...
            ///// Invio RPT
            $command = "curl --insecure https://pagopatest.agid.gov.it/cdi/serverPA/PAServerCoda.php";
            shell_exec( $command . "> /dev/null 2>/dev/null &" );
            /////

            ///// Invio RT
            $command = "curl --insecure https://pagopatest.agid.gov.it/cdi/serverPA/PSPServerCoda.php";
            shell_exec( $command . "> /dev/null 2>/dev/null &" );
            /////

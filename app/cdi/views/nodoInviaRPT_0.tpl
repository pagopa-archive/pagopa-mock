                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text"  class="form-control" id="importoSingoloVersamento1" name="importoSingoloVersamento1" value="{$IMPORTOPGAMENTO1}">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" class="form-control" id="importoSingoloVersamento2" name="importoSingoloVersamento2" value="{$IMPORTOPGAMENTO2}">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" class="form-control" id="importoSingoloVersamento3" name="importoSingoloVersamento3" value="{$IMPORTOPGAMENTO3}">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" class="form-control" id="importoSingoloVersamento4" name="importoSingoloVersamento4" value="{$IMPORTOPGAMENTO4}">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text" class="form-control" id="importoSingoloVersamento5" name="importoSingoloVersamento5" value="{$IMPORTOPGAMENTO5}">
                                                            </div>
                                                            <div class="form-group col-md-12">

<?php
/* Smarty version 3.1.33, created on 2019-06-10 11:50:14
  from '/var/www/html/moc/cdi/views/nodoInviaRPT_0_2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5cfe27d6836205_10417904',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '32e592d6858379260a3b3e50fbe8995ca32fbaa7' => 
    array (
      0 => '/var/www/html/moc/cdi/views/nodoInviaRPT_0_2.tpl',
      1 => 1560160177,
      2 => 'file',
    ),
  ),
...
function content_5cfe27d6836205_10417904 (Smarty_Internal_Template $_smarty_tpl) {
...
<div class="container-fluid m-4">
    <div class="row">
        <div class="col-md-9">
            ...
            <div>
                <form method="post" action="nodoInviaRPT2.php" id="formInviaRPT" autocomplete="off">
                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <span class="input-number input-number-currency">
                                                                    <input type="number" id="importoSingoloVersamento1" name="importoSingoloVersamento1" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO1']->value;?>
" min="0" step="0.01">
                                                                    <button class="input-number-add">
                                                                        <span class="sr-only">Aumenta valore Euro</span>
                                                                    </button>
                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <span class="input-number input-number-currency">
                                                                    <input type="number" id="importoSingoloVersamento2" name="importoSingoloVersamento2" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO2']->value;?>
" min="0" step="0.01">
                                                                    <button class="input-number-add">
                                                                        <span class="sr-only">Aumenta valore Euro</span>
                                                                    </button>
                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <span class="input-number input-number-currency">
                                                                    <input type="number" id="importoSingoloVersamento3" name="importoSingoloVersamento3" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO3']->value;?>
" min="0" step="0.01">
                                                                    <button class="input-number-add">
                                                                        <span class="sr-only">Aumenta valore Euro</span>
                                                                    </button>
                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <span class="input-number input-number-currency">
                                                                    <input type="number" id="importoSingoloVersamento4" name="importoSingoloVersamento4" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO4']->value;?>
" min="0" step="0.01">
                                                                    <button class="input-number-add">
                                                                        <span class="sr-only">Aumenta valore Euro</span>
                                                                    </button>
                                                    ...
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <span class="input-number input-number-currency">
                                                                    <input type="number" id="importoSingoloVersamento5" name="importoSingoloVersamento5" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO5']->value;?>
" min="0" step="0.01">
                                                                    <button class="input-number-add">
                                                                        <span class="sr-only">Aumenta valore Euro</span>
                                                                    </button>

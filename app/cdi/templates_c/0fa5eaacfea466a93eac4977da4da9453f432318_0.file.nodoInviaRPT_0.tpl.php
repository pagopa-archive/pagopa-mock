<?php
/* Smarty version 3.1.33, created on 2019-06-13 18:23:22
  from '/var/www/html/moc/cdi/views/nodoInviaRPT_0.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5d02787a8934e0_17964406',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0fa5eaacfea466a93eac4977da4da9453f432318' => 
    array (
      0 => '/var/www/html/moc/cdi/views/nodoInviaRPT_0.tpl',
      1 => 1560345682,
      2 => 'file',
    ),
  ),
...
function content_5d02787a8934e0_17964406 (Smarty_Internal_Template $_smarty_tpl) {
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="text" class="form-control"
                                                       ...
                                                       placeholder="identificativoUnivocoVersamento" value="<?php echo $_smarty_tpl->tpl_vars['IUV']->value;?>
">
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="text" class="form-control" id="codiceContestoPagamento" name="codiceContestoPagamento"
                                                       placeholder="codiceContestoPagamento" value="<?php echo $_smarty_tpl->tpl_vars['CCP']->value;?>
">
                                ...
                                <div class="card card-bg">
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="text" class="form-control" id="identificativoDominioRPT" name="identificativoDominioRPT"
                                                       placeholder="identificativoDominioRPT" value="77777777777">
                                                <label for="identificativoDominioRPT">identificativoDominio (RPT)</label>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <input type="text" class="form-control"
                                                       id="identificativoMessaggioRichiesta" name="identificativoMessaggioRichiesta"
                                                       placeholder="identificativoMessaggioRichiesta" value="<?php echo $_smarty_tpl->tpl_vars['IDM']->value;?>
">
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="text" class="form-control" id="dataOraMessaggioRichiesta" name="dataOraMessaggioRichiesta"
                                                       placeholder="dataOraMessaggioRichiesta" value="<?php echo $_smarty_tpl->tpl_vars['DATARICHIESTA']->value;?>
">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" id="dataEsecuzionePagamento" name="dataEsecuzionePagamento"
                                                                       placeholder="dataEsecuzionePagamento" value="<?php echo $_smarty_tpl->tpl_vars['DATAPAGAMENTO']->value;?>
">
                                                                <label for="dataEsecuzionePagamento">dataEsecuzionePagamento</label>
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                                <label for="importoTotaleDaVersare">importoTotaleDaVersare</label>
                                                                <input type="text" class="form-control" id="importoTotaleDaVersare" name="importoTotaleDaVersare" placeholder="Il totale viene calcolato automaticamente se il campo viene lasciato vuoto" value="">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="card-wrapper card-space">
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label for="importoSingoloVersamento1">importoSingoloVersamento</label>
                                                                <input type="text"  class="form-control" id="importoSingoloVersamento1" name="importoSingoloVersamento1" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO1']->value;?>
">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" id="causaleVersamento1" name="causaleVersamento1"
                                                                       placeholder="causaleVersamento" value="<?php echo $_smarty_tpl->tpl_vars['CAUSALE1']->value;?>
">
                                                ...
                                                <div class="card-wrapper card-space">
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label for="importoSingoloVersamento2">importoSingoloVersamento</label>
                                                                <input type="text" class="form-control" id="importoSingoloVersamento2" name="importoSingoloVersamento2" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO2']->value;?>
">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" id="causaleVersamento2" name="causaleVersamento2"
                                                                       placeholder="causaleVersamento" value="<?php echo $_smarty_tpl->tpl_vars['CAUSALE2']->value;?>
">
                                                ...
                                                <div class="card-wrapper card-space">
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label for="importoSingoloVersamento3">importoSingoloVersamento</label>
                                                                <input type="text" class="form-control" id="importoSingoloVersamento3" name="importoSingoloVersamento3" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO3']->value;?>
">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" id="causaleVersamento3" name="causaleVersamento3"
                                                                       placeholder="causaleVersamento" value="<?php echo $_smarty_tpl->tpl_vars['CAUSALE3']->value;?>
">
                                                ...
                                                <div class="card-wrapper card-space">
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label for="importoSingoloVersamento4">importoSingoloVersamento</label>
                                                                <input type="text" class="form-control" id="importoSingoloVersamento4" name="importoSingoloVersamento4" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO4']->value;?>
">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" id="causaleVersamento4" name="causaleVersamento4"
                                                                       placeholder="causaleVersamento" value="<?php echo $_smarty_tpl->tpl_vars['CAUSALE4']->value;?>
">
                                                ...
                                                <div class="card-wrapper card-space">
                                                    <div class="card card-bg">
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label for="importoSingoloVersamento5">importoSingoloVersamento</label>
                                                                <input type="text" class="form-control" id="importoSingoloVersamento5" name="importoSingoloVersamento5" value="<?php echo $_smarty_tpl->tpl_vars['IMPORTOPGAMENTO5']->value;?>
">
                                                            </div>
                                                            <div class="form-group col-md-12">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <input type="text" class="form-control" id="causaleVersamento5" name="causaleVersamento5"
                                                                       placeholder="causaleVersamento" value="<?php echo $_smarty_tpl->tpl_vars['CAUSALE5']->value;?>
">

...
<body>
<form action="../actions/actionnodoInviaCarrelloRPT.php" method="post" autocomplete="off">
    <fieldset>
	    ...
	    codiceContestoPagamento: <input type="text" name="codiceContestoPagamento" value="<?php echo$CCP?>"><br>
            ...
            <fieldset id="rpt">
                <legend>RPT</legend>
                versioneOggetto: <input type="text" name="versioneOggetto" value="6.2.0"><br>
                identificativoDominio: <input type="text" name="identificativoDominio" value="77777777777"><br>
		identificativoMessaggioRichiesta: <input type="text" name="identificativoMessaggioRichiesta" value="<?php echo$IDM;?>"><br>
		    ...
		    codiceIdentificativoUnivoco: <select type="text" name="codiceIdentificativoUnivocoP">
		    <option value="MFAAC145L5048202">MarioGammaldi</option>
                    <option value="WLZPLA89E24E801W">GianniPapetti</option>
                    </select><br>
		    ...
		    <option value="IT23S0200811758000004661823">Unicredit </option>
			</select><br>
